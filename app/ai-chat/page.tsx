...
export default function AiChatPage() {
    ...
    // ฟังก์ชันปุ่มคำแนะนำด่วนที่ลึกซึ้งมากขึ้น
    const quickSuggestions = [
        "ฉันรู้สึกเศร้าและต้องการคำปรึกษา",
        "เราทะเลาะกันและฉันไม่รู้จะทำยังไง",
        "ฉันอยากเข้าใจจิตใจคนรักมากขึ้น",
        "ช่วยแนะนำวิธีสื่อสารที่ดีกับคนรัก",
        "ฉันรู้สึกไม่มั่นใจในความสัมพันธ์",
        "อยากได้คำแนะนำการแสดงความรัก"
    ];
                    ...
                    {messages.length === 1 && !isLoading && (
                        <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-5 border border-pink-200 shadow-lg">
                            <h3 className="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
                                💡 คำถามที่มักถูกถาม - เลือกสิ่งที่ใกล้เคียงกับความรู้สึกของคุณ
                            </h3>
                ...
                <div className="max-w-3xl mx-auto">
                    <form onSubmit={handleSendMessage} className="flex items-center gap-3">
                        <input
                            ...
                            placeholder="บอกฉันเกี่ยวกับความรู้สึกของคุณ ฉันจะเข้าใจและให้คำปรึกษา..."
